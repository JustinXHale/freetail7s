/** Official-style Google / Apple sign-in controls (MatchReadyTX / TO3 pattern). */

import './SocialSignInButtons.css'
...
export function GoogleSignInButton({
  ...
  return (
    <button
      type="button"
      className="social-signin-btn social-signin-btn--google"
      disabled={disabled || busy}
      onClick={onClick}
    >
      {busy ? (
        <span className="social-signin-btn__spinner" aria-hidden />
      ) : (
        <GoogleGIcon />
      )}
...
export function AppleSignInButton({
  ...
  return (
    <button
      type="button"
      className="social-signin-btn social-signin-btn--apple"
      disabled={disabled || busy}
      onClick={onClick}
    >
      {busy ? (
