...
Team managers are responsible for ensuring players and staff know these rules.

**Entry fees, withdrawals, refunds, and prizes** are published on the public **Apply** page (`/apply`), not in this competition handbook.

---

## Overview

*All divisions — event shape, contact, Premier age, and where fees live.*
...
### Entry fees, refunds, and prizes

Entry fees, multi-division discounts, withdrawals, refunds, and champion prizes are published on the Apply page (`/apply`), not in this competition handbook.

---

## Match day

*On the day — staging, kick-off readiness, kits, laws, squads, and stoppages.*
...
### Squads, substitutions, and stoppages
...
*On the field — pool points, tiebreakers, knockout extras, and forfeits.*

### Pool competition points
...
### Pool table tiebreakers

If two or more teams are equal on competition points, ranking is decided in this order:

1. Head-to-head result among the tied teams (when two teams are tied and have played each other)
2. Point differential (points for minus points against) across all pool matches
3. Lowest points against across all pool matches
4. Most points scored across all pool matches
5. Coin toss between the team managers concerned

### Knockout and placement matches

Knockout and placement matches cannot end in a draw. If scores are level after full time:

1. Two periods of three (3) minutes of sudden-death play. Replacements are reset for extra time. The first team to score wins.
2. If still level: a conversion shootout. Kickers may be any player who has taken the field or any unused replacement.
3. Best of three from the 22-metre line: first from one sideline, then from the middle, then from the opposite sideline.
4. If still level: move to the 40-metre line, sudden death (if one team makes and the other misses, the maker wins).
5. If all attempts miss from the 40: return to the 22, still sudden death.

### Forfeit, no-show, and abandonment
...
*Governance — score confirmation, protests, cards, and how rulings are made.*

### Results, protests, and disputes
...
## Check-in, conduct, and medical

*At the venue — accreditation, technical area, conduct, alcohol, and player welfare.*

### Check-in, accreditation, and technical area
...
## Elite U18 Boys and Girls

*Age-grade competition — applies only to Elite U18, in addition to the general rules above.*
